...
//       {/* Amenities List (Only Show When Button Clicked) */}
//       {showAmenities && (
...
//           {/* Action Buttons (Cancel on Left, Apply on Right) */}
//           <div className="flex justify-between mt-4">
//             <button
...
//   return (
//     <div className="bg-blue-100 p-3 flex flex-wrap gap-2 items-center rounded-lg relative">
//       {/* Search Inputs */}
//       {Array(3)
//         .fill(0)
//         .map((_, index) => (
...
//             <input
//               type="text"
//               placeholder={index === 2 ? "Property Name" : "Enter area, city"}
//               className="px-3 py-1.5 pl-8 border bg-white border-gray-300 rounded-full text-gray-700 font-medium focus:ring-2 focus:ring-blue-400 focus:outline-none w-full"
//             />
//             <FaSearch className="absolute left-2.5 top-2 text-blue-600 text-sm" />
//           </div>
